...
- **Follow the open Agent Skills specification**: Follow the guidelines at [agentskills.io](https://agentskills.io), so skills you create can work across platforms that adopt the standard.
